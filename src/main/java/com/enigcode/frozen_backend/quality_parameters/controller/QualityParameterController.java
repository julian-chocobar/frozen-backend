...
public class QualityParameterController {
    ...
    @Operation(summary = "Crear parámetro de calidad", description = "Crea un parámetro de calidad nuevo para una fase en especifico")
    @PostMapping
    ...
    @Operation(summary = "Update parámetro de calidad", description = "Modifica la descripción de un parámetro de calidad existente")
    @PatchMapping("/{id}")
    @PreAuthorize("hasRole('SUPERVISOR_DE_CALIDAD')")
    ...
    @Operation(summary = "Cambiar activo en parámetro de calidad", description = "Cambia el estado activo de un parámetro de calidad existente")
    ...
    @Operation(summary = "Ver parámetro de calidad", description = "Ver parámetro de calidad especifico")
    @GetMapping("/{id}")
    ...
    @Operation(summary = "Ver todos los parámetros de calidad", description = "Ver todos los parámetros de calidad")
    @GetMapping
    ...
    public ResponseEntity<List<QualityParameterSimpleDTO>> getActiveQualityParametersSimple(
        ...
        if (phase != null) {
            ...
            dto = qualityParameterService.getActiveQualityParameters();
        }
