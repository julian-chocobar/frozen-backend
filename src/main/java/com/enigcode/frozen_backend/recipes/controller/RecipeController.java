...
public class RecipeController {
    ...
    @Operation(summary = "Registrar receta", description = "Registra una nueva receta en la base de datos")
    @PostMapping
    ...
    @Operation(summary = "Modificar receta", description = "Modifica una receta en especifico segun el id ")
    @PatchMapping("/{id}")
    @PreAuthorize("hasRole('SUPERVISOR_DE_PRODUCCION')")
    ...
    @Operation(summary = "Eliminar receta", description = "Elimina una receta segun su id")
    @DeleteMapping("/{id}")
    @PreAuthorize("hasRole('SUPERVISOR_DE_PRODUCCION')")
    ...
    @Operation(summary = "Obtener receta", description = "Obtiene una receta a partir de su id")
    @GetMapping("/{id}")
    ...
    @Operation(summary = "Obtener lista simple de recetas", description = "Obtiene una lista simple con id y nombre de todas las recetas activas")
    @GetMapping("/list")
    ...
    @Operation(summary = "Obtener materiales por fase", description = "Obtiene una lista de materiales asociados a una fase segun el id de la fase")
    ...
    @Operation(summary = "Obtener materiales por producto", description = "Obtiene una lista de materiales asociados a un producto segun el id de la producto")
