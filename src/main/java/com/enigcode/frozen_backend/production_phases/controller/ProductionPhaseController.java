...
public class ProductionPhaseController {
    ...
    @Operation(summary = "Enviar a revision lote después de la fase", description = "El supervisor de produccion del sector envía su fase a ser revisada por calidad")
    ...
    @Operation(summary = "Revision de parámetros de calidad", description = "Revisa los parámetros de calidad y puede aprobar y completar la fase, rechazarla y cancelarla"
            +
    ...
    @Operation(summary = "Ver una production phase", description = "Ver una production phase en especifico segun id")
    @GetMapping("/{id}")
    ...
    @Operation(summary = "Ver production phase por batch", description = "Ver una lista de production phase segun id del batch")
    ...
    public ResponseEntity<List<ProductionPhaseResponseDTO>> getProductionPhasesByBatch(@PathVariable Long id) {
        List<ProductionPhaseResponseDTO> productionPhaseResponseDTOs = productionPhaseService
                .getProductionPhasesByBatch(id);
