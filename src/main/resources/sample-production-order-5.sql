-- Script SQL para cargar datos de ejemplo de orden de producción 5 (Noviembre 10, 2025)
-- Este script asume que ya existen: productos, packagings, usuarios, sectores, quality_parameters y recipes
-- Orden 5: Noviembre 10, 2025 (SIN DESPERDICIO - eficiencia 100%, completada antes del 20 de noviembre)
...
BEGIN
    ...
    VALUES (
        ...
        '2025-11-10 09:00:00'::timestamptz,
        '2025-11-10 09:00:00'::timestamptz,
        '2025-11-19 09:00:00'::timestamptz,
        '2025-11-19 09:00:00'::timestamptz
    ...
    VALUES (
        ...
        output_unit_val,
        '2025-11-18 20:30:00'::timestamptz,
        '2025-11-19 00:30:00'::timestamptz
    ...
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase5_7_id, quality_param_id, '2.4 vol CO2', true, true, 1, '2025-11-18 20:30:00'::timestamptz);
    ...
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase5_7_id, quality_param_id, '18 psi', true, true, 1, '2025-11-18 20:30:00'::timestamptz);
    ...
    VALUES (
        ...
        output_unit_val,
        '2025-11-19 00:30:00'::timestamptz,
        '2025-11-19 08:30:00'::timestamptz
    ...
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase5_8_id, quality_param_id, 'OK', true, true, 1, '2025-11-19 00:30:00'::timestamptz);
