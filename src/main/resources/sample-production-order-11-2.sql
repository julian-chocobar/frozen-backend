...
BEGIN
    ...
    multiplier := 1.0;
    -- MUCHO DESPERDICIO: 90% eficiencia final = 0.90^(1/6) por fase
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_1_id,
                ROUND(recipe_quantity * multiplier * 1000000.0) / 1000000.0, '2025-10-02 14:00:00'::timestamptz);
    END LOOP;
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_2_id,
                ROUND(recipe_quantity * multiplier * 1000000.0) / 1000000.0, '2025-10-02 16:30:00'::timestamptz);
    END LOOP;
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_3_id,
                ROUND(recipe_quantity * multiplier * 1000000.0) / 1000000.0, '2025-10-02 22:30:00'::timestamptz);
    END LOOP;
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_4_id,
                ROUND(recipe_quantity * multiplier * 1000000.0) / 1000000.0, '2025-10-03 01:00:00'::timestamptz);
    END LOOP;
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_5_id,
                ROUND(recipe_quantity * multiplier * 1000000.0) / 1000000.0, '2025-10-03 04:00:00'::timestamptz);
    END LOOP;
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_6_id,
                ROUND(recipe_quantity * multiplier * 1000000.0) / 1000000.0, '2025-10-11 04:00:00'::timestamptz);
    END LOOP;
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_7_id,
                ROUND(recipe_quantity * multiplier * 1000000.0) / 1000000.0, '2025-10-21 04:00:00'::timestamptz);
    END LOOP;
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_8_id,
                ROUND(recipe_quantity * multiplier * 1000000.0) / 1000000.0, '2025-10-21 08:00:00'::timestamptz);
    END LOOP;
    ...
    RAISE NOTICE 'Orden de producción Noviembre-2 cargada exitosamente - Output final: % LT', ROUND(current_output * 1000.0) / 1000.0;
