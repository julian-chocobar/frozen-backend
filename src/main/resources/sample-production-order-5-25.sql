-- Script SQL para cargar datos de ejemplo de orden de producción - Junio 25, 2025
-- Producto: Stout Intensa - Packaging: Barril 20L
-- Eficiencia: 100% (sin desperdicio) - Output final esperado: 800 LT
...
BEGIN
    ...
    VALUES (
        ...
        '2025-06-25 11:00:00'::timestamptz,
        '2025-06-25 11:00:00'::timestamptz,
        '2025-06-25 11:00:00'::timestamptz,
        '2025-07-25 09:30:00'::timestamptz,
        '2025-07-25 09:30:00'::timestamptz
    ...
    -- SIN DESPERDICIO: eficiencia 100%
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_1_id,
                ROUND(recipe_quantity * multiplier * 100.0) / 100.0, '2025-06-25 09:00:00'::timestamptz);
    END LOOP;
    ...
    VALUES (nextval('production_phases_qualities_seq'), phase_1_id, quality_param_id, '350 μm', true, true, 1, '2025-06-25 09:00:00'::timestamptz);
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'MOLIENDA' AND name = 'Humedad Malta';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_1_id, quality_param_id, '4.5 %', true, true, 1, '2025-06-25 09:00:00'::timestamptz);
    ...
    VALUES (
        ...
        '2025-06-25 11:00:00'::timestamptz,
        '2025-06-25 16:00:00'::timestamptz
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_2_id,
                ROUND(recipe_quantity * multiplier * 100.0) / 100.0, '2025-06-25 11:00:00'::timestamptz);
    END LOOP;
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'MACERACION' AND name = 'Temp Macerac';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_2_id, quality_param_id, '68 °C', true, true, 1, '2025-06-25 11:00:00'::timestamptz);
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'MACERACION' AND name = 'pH Macerac';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_2_id, quality_param_id, '5.5 pH', true, true, 1, '2025-06-25 11:00:00'::timestamptz);
    ...
    VALUES (
        ...
        ROUND((standard_output * multiplier * (current_input / (standard_input * multiplier)) - current_output) * 100.0) / 100.0,
        '2025-06-25 16:00:00'::timestamptz,
        '2025-06-25 18:00:00'::timestamptz
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_3_id,
                ROUND(recipe_quantity * multiplier * 100.0) / 100.0, '2025-06-25 16:00:00'::timestamptz);
    END LOOP;
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'FILTRACION' AND name = 'Claridad';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_3_id, quality_param_id, '15 NTU', true, true, 1, '2025-06-25 16:00:00'::timestamptz);
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'FILTRACION' AND name = 'Temp Filtrado';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_3_id, quality_param_id, '78 °C', true, true, 1, '2025-06-25 16:00:00'::timestamptz);
    ...
    VALUES (
        ...
        ROUND((standard_output * multiplier * (current_input / (standard_input * multiplier)) - current_output) * 100.0) / 100.0,
        '2025-06-25 18:00:00'::timestamptz,
        '2025-06-25 20:30:00'::timestamptz
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_4_id,
                ROUND(recipe_quantity * multiplier * 100.0) / 100.0, '2025-06-25 18:00:00'::timestamptz);
    END LOOP;
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'COCCION' AND name = 'Plato Final';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_4_id, quality_param_id, '16.8 °P', true, true, 1, '2025-06-25 18:00:00'::timestamptz);
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'COCCION' AND name = 'Tiempo Lupulo';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_4_id, quality_param_id, '15 min', true, true, 1, '2025-06-25 18:00:00'::timestamptz);
    ...
    VALUES (
        ...
        ROUND((standard_output * multiplier * (current_input / (standard_input * multiplier)) - current_output) * 100.0) / 100.0,
        '2025-06-25 20:30:00'::timestamptz,
        '2025-07-02 20:30:00'::timestamptz
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_5_id,
                ROUND(recipe_quantity * multiplier * 100.0) / 100.0, '2025-06-25 20:30:00'::timestamptz);
    END LOOP;
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'FERMENTACION' AND name = 'Temp Ferm';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_5_id, quality_param_id, '18 °C', true, true, 1, '2025-06-25 20:30:00'::timestamptz);
    ...
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_5_id, quality_param_id, '1.012 SG', true, true, 1, '2025-06-25 20:30:00'::timestamptz);
    ...
    VALUES (
        ...
        ROUND((standard_output * multiplier * (current_input / (standard_input * multiplier)) - current_output) * 100.0) / 100.0,
        '2025-07-02 20:30:00'::timestamptz,
        '2025-07-12 20:30:00'::timestamptz
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_6_id,
                ROUND(recipe_quantity * multiplier * 100.0) / 100.0, '2025-07-02 20:30:00'::timestamptz);
    END LOOP;
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'MADURACION' AND name = 'Diacetilo';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_6_id, quality_param_id, '0.08 ppm', true, true, 1, '2025-07-02 20:30:00'::timestamptz);
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'MADURACION' AND name = 'Turbidez';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_6_id, quality_param_id, '5 EBC', true, true, 1, '2025-07-02 20:30:00'::timestamptz);
    ...
    VALUES (
        ...
        ROUND((standard_output * multiplier * (current_input / (standard_input * multiplier)) - current_output) * 100.0) / 100.0,
        '2025-07-12 20:30:00'::timestamptz,
        '2025-07-12 23:30:00'::timestamptz
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_7_id,
                ROUND(recipe_quantity * multiplier * 100.0) / 100.0, '2025-07-12 20:30:00'::timestamptz);
    END LOOP;
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'GASIFICACION' AND name = 'CO2 Volumen';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_7_id, quality_param_id, '2.2 vol CO2', true, true, 1, '2025-07-12 20:30:00'::timestamptz);
    ...
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_7_id, quality_param_id, '16 psi', true, true, 1, '2025-07-12 20:30:00'::timestamptz);
    ...
    VALUES (
        ...
        ROUND((standard_output * multiplier * (current_input / (standard_input * multiplier)) - current_output) * 100.0) / 100.0,
        '2025-07-12 23:30:00'::timestamptz,
        '2025-07-25 02:00:00'::timestamptz
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_8_id,
                ROUND(recipe_quantity * multiplier * 100.0) / 100.0, '2025-07-12 23:30:00'::timestamptz);
    END LOOP;
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'ENVASADO' AND name = 'Sellado';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_8_id, quality_param_id, 'Hermético', true, true, 1, '2025-07-12 23:30:00'::timestamptz);
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'ENVASADO' AND name = 'Etiquetado';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_8_id, quality_param_id, 'OK', true, true, 1, '2025-07-12 23:30:00'::timestamptz);
    
    RAISE NOTICE 'Orden de producción Junio-25 cargada exitosamente - Output final: % LT', ROUND(current_output * 100.0) / 100.0;
