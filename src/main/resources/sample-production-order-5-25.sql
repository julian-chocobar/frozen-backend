...
BEGIN
    ...
    VALUES (
        ...
        '2025-05-25 11:00:00'::timestamptz,
        '2025-05-25 11:00:00'::timestamptz,
        '2025-05-25 11:00:00'::timestamptz,
        '2025-06-25 09:30:00'::timestamptz,
        '2025-06-25 09:30:00'::timestamptz
    ...
    VALUES (
        ...
        '2025-05-25 09:00:00'::timestamptz,
        '2025-05-25 11:00:00'::timestamptz
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_1_id,
                ROUND(recipe_quantity * multiplier * 1000000.0) / 1000000.0, '2025-05-25 11:00:00'::timestamptz);
    END LOOP;
    ...
    VALUES (nextval('production_phases_qualities_seq'), phase_1_id, quality_param_id, '350 μm', true, true, 1, '2025-05-25 11:00:00'::timestamptz);
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'MOLIENDA' AND name = 'Humedad Malta';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_1_id, quality_param_id, '4.5 %', true, true, 1, '2025-05-25 11:00:00'::timestamptz);
    ...
    VALUES (
        ...
        ROUND((standard_output * (current_input / standard_input) - current_output) * 1000.0) / 1000.0,
        '2025-05-25 11:00:00'::timestamptz,
        '2025-05-25 16:00:00'::timestamptz
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_2_id,
                ROUND(recipe_quantity * multiplier * 1000000.0) / 1000000.0, '2025-05-25 13:30:00'::timestamptz);
    END LOOP;
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'MACERACION' AND name = 'Temp Macerac';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_2_id, quality_param_id, '68 °C', true, true, 1, '2025-05-25 13:30:00'::timestamptz);
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'MACERACION' AND name = 'pH Macerac';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_2_id, quality_param_id, '5.5 pH', true, true, 1, '2025-05-25 13:30:00'::timestamptz);
    ...
    VALUES (
        ...
        ROUND((standard_output * (current_input / standard_input) - current_output) * 1000.0) / 1000.0,
        '2025-05-25 16:00:00'::timestamptz,
        '2025-05-25 18:00:00'::timestamptz
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_3_id,
                ROUND(recipe_quantity * multiplier * 1000000.0) / 1000000.0, '2025-05-25 19:00:00'::timestamptz);
    END LOOP;
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'FILTRACION' AND name = 'Claridad';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_3_id, quality_param_id, '15 NTU', true, true, 1, '2025-05-25 19:00:00'::timestamptz);
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'FILTRACION' AND name = 'Temp Filtrado';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_3_id, quality_param_id, '78 °C', true, true, 1, '2025-05-25 19:00:00'::timestamptz);
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_4_id,
                ROUND(recipe_quantity * multiplier * 1000000.0) / 1000000.0, '2025-05-25 21:00:00'::timestamptz);
    END LOOP;
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'COCCION' AND name = 'Plato Final';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_4_id, quality_param_id, '16.8 °P', true, true, 1, '2025-05-25 21:00:00'::timestamptz);
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'COCCION' AND name = 'Tiempo Lupulo';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_4_id, quality_param_id, '15 min', true, true, 1, '2025-05-25 21:00:00'::timestamptz);
    ...
    VALUES (
        ...
        ROUND((standard_output * (current_input / standard_input) - current_output) * 1000.0) / 1000.0,
        '2025-05-25 20:30:00'::timestamptz,
        '2025-06-01 20:30:00'::timestamptz
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_5_id,
                ROUND(recipe_quantity * multiplier * 1000000.0) / 1000000.0, '2025-05-26 00:00:00'::timestamptz);
    END LOOP;
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'FERMENTACION' AND name = 'Temp Ferm';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_5_id, quality_param_id, '18 °C', true, true, 1, '2025-05-26 00:00:00'::timestamptz);
    ...
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_5_id, quality_param_id, '1.012 SG', true, true, 1, '2025-05-26 00:00:00'::timestamptz);
    ...
    VALUES (
        ...
        ROUND((standard_output * (current_input / standard_input) - current_output) * 1000.0) / 1000.0,
        '2025-06-01 20:30:00'::timestamptz,
        '2025-06-11 20:30:00'::timestamptz
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_6_id,
                ROUND(recipe_quantity * multiplier * 1000000.0) / 1000000.0, '2025-06-05 00:00:00'::timestamptz);
    END LOOP;
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'MADURACION' AND name = 'Diacetilo';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_6_id, quality_param_id, '0.08 ppm', true, true, 1, '2025-06-05 00:00:00'::timestamptz);
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'MADURACION' AND name = 'Turbidez';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_6_id, quality_param_id, '5 EBC', true, true, 1, '2025-06-05 00:00:00'::timestamptz);
    ...
    VALUES (
        ...
        ROUND((standard_output * (current_input / standard_input) - current_output) * 1000.0) / 1000.0,
        '2025-06-11 20:30:00'::timestamptz,
        '2025-06-11 23:30:00'::timestamptz
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_7_id,
                ROUND(recipe_quantity * multiplier * 1000000.0) / 1000000.0, '2025-06-15 00:00:00'::timestamptz);
    END LOOP;
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'GASIFICACION' AND name = 'CO2 Volumen';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_7_id, quality_param_id, '2.2 vol CO2', true, true, 1, '2025-06-15 00:00:00'::timestamptz);
    ...
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_7_id, quality_param_id, '16 psi', true, true, 1, '2025-06-15 00:00:00'::timestamptz);
    ...
    VALUES (
        ...
        ROUND((standard_output * (current_input / standard_input) - current_output) * 1000.0) / 1000.0,
        '2025-06-11 23:30:00'::timestamptz,
        '2025-06-24 02:00:00'::timestamptz
    ...
    LOOP
        ...
        VALUES (nextval('production_materials_seq'), recipe_material_id, phase_8_id,
                ROUND(recipe_quantity * multiplier * 1000000.0) / 1000000.0, '2025-06-15 03:30:00'::timestamptz);
    END LOOP;
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'ENVASADO' AND name = 'Sellado';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_8_id, quality_param_id, 'Hermético', true, true, 1, '2025-06-15 03:30:00'::timestamptz);
    
    SELECT id INTO quality_param_id FROM quality_parameters WHERE is_active = true AND phase = 'ENVASADO' AND name = 'Etiquetado';
    INSERT INTO production_phases_qualities (id, id_production_phase, id_quality_parameter, value, is_approved, is_active, version, realization_date)
    VALUES (nextval('production_phases_qualities_seq'), phase_8_id, quality_param_id, 'OK', true, true, 1, '2025-06-15 03:30:00'::timestamptz);
    
    RAISE NOTICE 'Orden de producción Junio-25 cargada exitosamente - Output final: % LT', ROUND(current_output * 1000.0) / 1000.0;
